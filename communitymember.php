...
if($temr)    
  { //check for member 
    ...
    $res=mysql_query("SELECT * from profile Where email IN (SELECT owner from community where id=".$communityid.")");
    $own= mysql_fetch_array($res);
    $owner="\"$own[email]\""; 
    $ownername = $own[firstname];
    ...
    if(isset($_POST['Delete']))
    {
      ...
      if ($owner == $user) 
      {
        $result = mysql_query("DELETE from posts where communityid =".$communityid);
        $result = mysql_query("DELETE from topic where communityid =".$communityid);
        $result2 = mysql_query("DELETE from community where id =".$communityid);
        if($result2)
        {
      ...
      else
      {
         ...
         echo "Only owners can delete the groups";
      }
    }
    ...
    <div class="main">
      <div class="main_resize">
        <div class="header">
           ...
           <div class="hbg">
          <img src="img/geekgrp.jpg" width="300" height="120" alt="" align= "right"/></div>
            <div class="clr"></div>
            <div class="menu_nav">
              <ul>
    ...
    <!--         <td width="280" valign="top">
             <div id="slideshow">
              ...
              <td width="573" valign="top">
                ...
                <?php echo "You are a member of this Community";  ?>
                <p></p>  
                <form id="form1" name="form1" method="post">
                  ...
                  <tr> 
                    ...
                    <td width="73%"><?php echo $ownername;  ?></td>
                  </tr>
                  <p></p>
                  <tr> 
                  <td colspan="2"> 
